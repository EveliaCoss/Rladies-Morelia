...
```{r}
rm(infoCharacters, infoPowers, infoStats, marvelDc_edited, marvelDc, marvelDcAlignment, fullMarvelDc, marvelDcGender, marvelDcStatsInfo, marvelDcInfo)
```
